...
export function Hero() {
  return (
    <div className="pt-4 lg:pt-10">
      <div className="px-[20px] lg:px-[200px] xl:px-[280px]">
        ...
        <div className="flex w-full pt-8 justify-center gap-x-6">
          <button className="bg-[#4328EB] w-1/2 py-4 px-8 text-white rounded-[4px] md:w-fit">
            Try for Free
          </button>
          <button className="text-[#4328EB] w-1/2 flex items-center justify-center gap-x-2 md:w-fit">
            View Pricing{" "}
            <span>
      ...
      <div className="relative flex h-full w-full justify-center">
        ...
        <div className="absolute bottom-5 flex w-full flex-col items-center">
          <Image
            src={HeroImage}
            alt="HeroImg"
            className="-ml-4 h-[310px] sm:-mb-20 sm:h-[400px] md:-mb-200 md:h-[480px] lg:-mb-6 lg:h-[620px] xl:w-[80%]"
          />
